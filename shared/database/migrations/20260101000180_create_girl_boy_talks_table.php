...
/**
 * Baseline migration for the `girl_boy_talks` table - schema captured verbatim (SHOW CREATE TABLE)
...
return new class {
    ...
    {
        $db->exec("DROP TABLE IF EXISTS `girl_boy_talks`");
    }
};
