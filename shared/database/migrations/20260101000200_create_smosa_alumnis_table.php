...
/**
 * Baseline migration for the `smosa_alumnis` table - schema captured verbatim (SHOW CREATE TABLE)
...
return new class {
    ...
    {
        $db->exec("DROP TABLE IF EXISTS `smosa_alumnis`");
    }
};
