...
/**
 * Baseline migration for the `chaplaincies` table - schema captured verbatim (SHOW CREATE TABLE)
...
return new class {
    ...
    {
        $db->exec("DROP TABLE IF EXISTS `chaplaincies`");
    }
};
