...
/**
 * Baseline migration for the `inspiration_nights` table - schema captured verbatim (SHOW CREATE TABLE)
...
return new class {
    ...
    {
        $db->exec(<<<SQL
            CREATE TABLE `inspiration_nights` (
    ...
    {
        $db->exec("DROP TABLE IF EXISTS `inspiration_nights`");
    }
};
