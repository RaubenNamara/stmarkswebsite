...
const form = useForm({
  student_name: props.campusVoice.student_name,
  title: props.campusVoice.title,
  author_bio: props.campusVoice.author_bio || '',
  content: props.campusVoice.content,
  featured_image: null,
  category: props.campusVoice.category,
  featured: props.campusVoice.featured,
  status: props.campusVoice.status,
})

const preview = ref(props.campusVoice.image_url)
...
async function handleFile(e) {
  ...
  if (!file) {
    ...
    preview.value = props.campusVoice.image_url
    return
  }
...
*/
function submit() {
  form.put(route('admin.campus-voices.update', props.campusVoice.id), {
    onSuccess: () => {
      form.featured_image = null
    }
  })
...
<template>
  <Head :title="'Edit Campus Voice - ' + campusVoice.title" />

  <div class="p-8 space-y-8">

    <!-- ================= HEADER ================= -->
    <div class="flex items-center justify-between">
      <h1 class="text-3xl font-bold text-gray-800">Edit Campus Voice Article</h1>
      <a
    ...
    <div class="bg-white rounded-lg shadow p-6">
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div>
          <label class="block text-sm font-medium mb-1">View Count</label>
          <input
            :value="campusVoice.views"
            type="text"
