...
const sortedMembers = computed(() =>
  [...props.members].sort((a, b) => Number(a?.id || 0) - Number(b?.id || 0))
)
    ...
    <section class="relative z-10 mx-auto w-full max-w-[1800px] px-4 py-12 sm:px-6 sm:py-14 lg:px-10 lg:py-16 xl:px-14 2xl:px-20">
      <header class="mx-auto mb-12 max-w-4xl text-center sm:mb-14 lg:mb-16">
        ...
        <p class="mx-auto mt-4 max-w-3xl text-sm leading-7 text-slate-600 sm:text-base lg:text-lg xl:text-xl">
          Meet our Board of Governors responsible for leadership, guidance, and strategic direction.
        </p>
      </header>
      ...
      >
        ...
        <p class="text-lg font-bold text-slate-800 sm:text-xl">No board members available.</p>
        <p class="mt-2 text-sm text-slate-500 sm:text-base">
          Board member profiles will appear here once they are added from the admin panel.
        </p>
      </div>
      ...
      <div v-else class="staff-grid">
        ...
        >
          ...
          <div class="relative p-6 sm:p-7 lg:p-8">
            ...
            <div v-if="member.position" class="mt-4 flex justify-center">
